...
[arXiv manuscript identifiers](https://info.arxiv.org/help/arxiv_identifier.html).
...
The [arXiv metadata](https://info.arxiv.org/help/prep.html) has a number of
...
[metadata instructions](https://info.arxiv.org/help/prep.html#author) may not be
widely read.
...
[arXiv API user manual](https://info.arxiv.org/help/api/user-manual.html) states:
